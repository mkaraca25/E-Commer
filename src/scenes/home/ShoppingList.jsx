...
const ShoppingList = () => {
  ...
  return <Box width="80%" margin="80px auto">
        ...
        indicatorColor="primary" value={value} onChange={handleChange} centered TabIndicatorProps={{display:isNonMobile ? "block": "none"}}
        sx={{
            m:"25px",
        ...
        <Box
        margin="0 auto" display="grid" gridTemplateColumns="repeat(auto-fill,300px)" justifyContent="space-around"
